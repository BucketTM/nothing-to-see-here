...
//SALT to xinuhash(char *passtext, int maxlen, ulong salt);
//see Auth.h for the stuff to use
//Login.c (in shell) should't be changed but has how all the functions in auth.h
//if (getusername==0){idk its either getusername or Username[]
//printf("please provide username"); to prompt the usename
//makeuser or getuser?}
//
//idk what to do for search
//if (!superusr){
